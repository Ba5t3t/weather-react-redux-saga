...
const fetchWeatherFromAPI = (unit = 'metric') => axios.get(`https://api.openweathermap.org/data/2.5/weather?q=Moscow&appid=c0c767d0dbd4142401b9bca74616fa02&lang=ru&units=${unit}`)
