...
const fetchWeatherFromAPI = (unit = 'metric', city = 'Saint Petersburg') => axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=c0c767d0dbd4142401b9bca74616fa02&lang=ru&units=${unit}`)
